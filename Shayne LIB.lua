do
    ...
    function Update:Window(text, savefolder)
        ...
        BindButton.Text = "[ " .. string.gsub(tostring(GUISettings.yoo), "Enum.KeyCode.", "") .. " ]"
        ...
        function uitab:Tab(text)
            ...
            TabButton.MouseButton1Click:Connect(function()
                for i, v in next, ScrollTab:GetChildren() do
                    if v:IsA("TextButton") then
                        TweenService:Create(v, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextTransparency = 0.5}):Play()
                    end
                    TweenService:Create(TabButton, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextTransparency = 0}):Play()
                end
            ...
            function main:Button(text, callback)
                ...
                TextBtn.MouseEnter:Connect(function()
                    TweenService:Create(Black, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundTransparency = 0.7}):Play()
                end)
                TextBtn.MouseLeave:Connect(function()
                    TweenService:Create(Black, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundTransparency = 1}):Play()
                end)
                TextBtn.MouseButton1Click:Connect(function()
                    TextBtn.TextSize = 0
                    TweenService:Create(TextBtn, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextSize = 15}):Play()
                    callback()
                end)
            end
            ...
            function main:Toggle(text, config, callback)
                ...
                Button.MouseButton1Click:Connect(function()
                    if toggled == false then
                        ...
                        TweenService:Create(Circle,TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{BackgroundColor3 = _G.Color}):Play()
                    else
                        toggled = false
                        Circle:TweenPosition(UDim2.new(0, 2, 0, 2), "Out", "Sine", 0.2, true)
                        TweenService:Create(Circle,TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{BackgroundColor3 = Color3.fromRGB(227, 60, 110)}):Play()
                    end
            ...
            function main:Dropdown(text, option, value, callback)
                ...
                DropButton.MouseButton1Click:Connect(function()
                    if isdropping == false then
                        ...
                        TweenService:Create(DropImage,TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{Rotation = 0}):Play()
                    else
                        isdropping = false
                        Dropdown:TweenSize(UDim2.new(0, 470, 0, 31), "Out", "Quad", 0.3, true)
                        TweenService:Create(DropImage,TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{Rotation = 180}):Play()
            ...
            function main:SliderToggle(text,config, min, max, set, callback)
                ...
                AHEHE.BackgroundTransparency = 1.000
                AHEHE.Position = UDim2.new(0, 10, 0, 35)
                AHEHE.Size = UDim2.new(0, 400, 0, 5)
                AHEHE.Font = Enum.Font.SourceSans
                AHEHE.Text = ""
                AHEHE.TextColor3 = Color3.fromRGB(0, 0, 0)
                AHEHE.TextSize = 14.000
                ...
                circlebar.Name = "circlebar"
                circlebar.Parent = bar1
                circlebar.BackgroundColor3 = Color3.fromRGB(255, 225, 225)
                circlebar.Position = UDim2.new(1, -2, 0, -3)
                circlebar.Size = UDim2.new(0, 10, 0, 10)
    
                UICorner.CornerRadius = UDim.new(0, 5)
                UICorner.Name = "UsICorner"
                UICorner.Parent = circlebar
                ...
                slidervalue.BackgroundColor3 = _G.Color
                slidervalue.BackgroundTransparency = 0
                slidervalue.Position = UDim2.new(0, 340, 0, 27)
                slidervalue.Size = UDim2.new(0, 65, 0, 18)
                ...
                AHEHE.MouseButton1Down:Connect(function()
                    ...
                    circlebar.Position = UDim2.new(0, math.clamp(mouse.X - bar1.AbsolutePosition.X - 2, 0, 315), 0, -3)
                    moveconnection = mouse.Move:Connect(function()
                        TextBox.Text = Value
                ...
                uis.InputEnded:Connect(function(Mouse)
                    if Mouse.UserInputType == Enum.UserInputType.MouseButton1 then
                        Value =
                            math.floor((((tonumber(max) - tonumber(min)) / 315) * bar1.AbsoluteSize.X) + tonumber(min))
                        TextBox.Text = Value
                    end
                end)
                ...
                Button.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
                Button.Position = UDim2.new(0, 415, 0, 25)
                ...
                ToggleImage.BackgroundColor3 = Color3.fromRGB(225, 225, 225)
                ToggleImage.Position = UDim2.new(0, 415, 0, 25)
                ToggleImage.Size = UDim2.new(0, 45, 0, 20)
            ...
            function main:NumberTextbox(text, value, callback)
                ...
                RealTextbox:GetPropertyChangedSignal("Text"):Connect(function()
                    RealTextbox.Text = RealTextbox.Text:gsub("%a", "")
                    if RealTextbox.Text:len() > 12 then
                        RealTextbox.Text = RealTextbox.Text:sub(1,12)
                    end
                end)
    
                RealTextbox.FocusLost:Connect(function()
                    RealTextbox.Text = string.format("%.3f", RealTextbox.Text)
                    value = RealTextbox.Text
                    if RealTextbox.Text:len() < 1 then
                        RealTextbox.Text = 1
                        value = RealTextbox.Text
                    end
                    pcall(function()
            ...
            function main:NumberTextboxToggle(text, value, config, callback)
                local Textbox = Instance.new("Frame")
                local TextboxCorner = Instance.new("UICorner")
                local Textboxx = Instance.new("Frame")
                local TextboxxCorner = Instance.new("UICorner")
                ...
                local toggled = config
                local Toggle = Instance.new("Frame")
                local UICorner_0 = Instance.new("UICorner")
                local Button = Instance.new("TextButton")
                local UICorner_2 = Instance.new("UICorner")
                local Label = Instance.new("TextLabel")
                local ToggleImage = Instance.new("Frame")
                ...
                RealTextbox.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
                RealTextbox.BackgroundTransparency = 0
                RealTextbox.Position = UDim2.new(0, 300, 0, 4)
                RealTextbox.Size = UDim2.new(0, 100, 0, 24)
                RealTextbox.Font = Enum.Font.GothamSemibold
                RealTextbox.Text = value
                RealTextbox.TextColor3 = Color3.fromRGB(255, 255, 255)
                ...
                Button.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
                Button.Position = UDim2.new(0, 415, 0, 4)
